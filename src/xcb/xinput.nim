...
proc changeDevicePropertyChecked*(c: ptr XcbConnection; property: XcbAtom; `type`: XcbAtom; device_id: uint8; format: uint8; mode: uint8; num_items: uint32; items: pointer): XcbVoidCookie {.discardable, importc: "xcb_input_change_device_property_checked".}
proc changeDeviceProperty*(c: ptr XcbConnection; property: XcbAtom; `type`: XcbAtom; device_id: uint8; format: uint8; mode: uint8; num_items: uint32; items: pointer): XcbVoidCookie {.discardable, importc: "xcb_input_change_device_property".}
proc changeDevicePropertyAuxChecked*(c: ptr XcbConnection; property: XcbAtom; `type`: XcbAtom; device_id: uint8; format: uint8; mode: uint8; num_items: uint32; items: ptr XcbInputChangeDevicePropertyItems): XcbVoidCookie {.discardable, importc: "xcb_input_change_device_property_aux_checked".}
proc changeDevicePropertyAux*(c: ptr XcbConnection; property: XcbAtom; `type`: XcbAtom; device_id: uint8; format: uint8; mode: uint8; num_items: uint32; items: ptr XcbInputChangeDevicePropertyItems): XcbVoidCookie {.discardable, importc: "xcb_input_change_device_property_aux".}
...
proc xiChangePropertyChecked*(c: ptr XcbConnection; deviceid: XcbInputDeviceId; mode: uint8; format: uint8; property: XcbAtom; `type`: XcbAtom; num_items: uint32; items: pointer): XcbVoidCookie {.discardable, importc: "xcb_input_xi_change_property_checked".}
proc xiChangeProperty*(c: ptr XcbConnection; deviceid: XcbInputDeviceId; mode: uint8; format: uint8; property: XcbAtom; `type`: XcbAtom; num_items: uint32; items: pointer): XcbVoidCookie {.discardable, importc: "xcb_input_xi_change_property".}
proc xiChangePropertyAuxChecked*(c: ptr XcbConnection; deviceid: XcbInputDeviceId; mode: uint8; format: uint8; property: XcbAtom; `type`: XcbAtom; num_items: uint32; items: ptr XcbInputXiChangePropertyItems): XcbVoidCookie {.discardable, importc: "xcb_input_xi_change_property_aux_checked".}
proc xiChangePropertyAux*(c: ptr XcbConnection; deviceid: XcbInputDeviceId; mode: uint8; format: uint8; property: XcbAtom; `type`: XcbAtom; num_items: uint32; items: ptr XcbInputXiChangePropertyItems): XcbVoidCookie {.discardable, importc: "xcb_input_xi_change_property_aux".}
