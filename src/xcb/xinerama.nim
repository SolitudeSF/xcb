...
type
  XcbXineramaScreenInfo* {.rename: "xcb_xinerama_screen_info_t", bycopy.} = object
    xOrg* {.importc: "x_org".}: int16
    yOrg* {.importc: "y_org".}: int16
    width*: uint16
    height*: uint16

  XcbXineramaScreenInfoIterator* {.rename: "xcb_xinerama_screen_info_iterator_t", bycopy.} = object
    data*: ptr UncheckedArray[XcbXineramaScreenInfo]
    rem*: cint
    index*: cint

  XcbXineramaQueryVersionCookie* {.rename: "xcb_xinerama_query_version_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaQueryVersionRequest* {.rename: "xcb_xinerama_query_version_request_t", bycopy.} = object
  ...
  XcbXineramaQueryVersionReply* {.rename: "xcb_xinerama_query_version_reply_t", bycopy.} = object
  ...
  XcbXineramaGetStateCookie* {.rename: "xcb_xinerama_get_state_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaGetStateRequest* {.rename: "xcb_xinerama_get_state_request_t", bycopy.} = object
    majorOpcode* {.importc: "major_opcode".}: uint8
    minorOpcode* {.importc: "minor_opcode".}: uint8
    length*: uint16
    window*: XcbWindow

  XcbXineramaGetStateReply* {.rename: "xcb_xinerama_get_state_reply_t", bycopy.} = object
    responseType* {.importc: "response_type".}: uint8
    state*: uint8
    sequence*: uint16
    length*: uint32
  ...
  XcbXineramaGetScreenCountCookie* {.rename: "xcb_xinerama_get_screen_count_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaGetScreenCountRequest* {.rename: "xcb_xinerama_get_screen_count_request_t", bycopy.} = object
    majorOpcode* {.importc: "major_opcode".}: uint8
    minorOpcode* {.importc: "minor_opcode".}: uint8
    length*: uint16
    window*: XcbWindow

  XcbXineramaGetScreenCountReply* {.rename: "xcb_xinerama_get_screen_count_reply_t", bycopy.} = object
    responseType* {.importc: "response_type".}: uint8
  ...
  XcbXineramaGetScreenSizeCookie* {.rename: "xcb_xinerama_get_screen_size_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaGetScreenSizeRequest* {.rename: "xcb_xinerama_get_screen_size_request_t", bycopy.} = object
    majorOpcode* {.importc: "major_opcode".}: uint8
    minorOpcode* {.importc: "minor_opcode".}: uint8
    length*: uint16
    window*: XcbWindow
  ...
  XcbXineramaGetScreenSizeReply* {.rename: "xcb_xinerama_get_screen_size_reply_t", bycopy.} = object
    responseType* {.importc: "response_type".}: uint8
    pad0: uint8
    sequence*: uint16
    length*: uint32
  ...
  XcbXineramaIsActiveCookie* {.rename: "xcb_xinerama_is_active_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaIsActiveRequest* {.rename: "xcb_xinerama_is_active_request_t", bycopy.} = object
    majorOpcode* {.importc: "major_opcode".}: uint8
    minorOpcode* {.importc: "minor_opcode".}: uint8
    length*: uint16

  XcbXineramaIsActiveReply* {.rename: "xcb_xinerama_is_active_reply_t", bycopy.} = object
    responseType* {.importc: "response_type".}: uint8
    pad0: uint8
    sequence*: uint16
    length*: uint32
  ...
  XcbXineramaQueryScreensCookie* {.rename: "xcb_xinerama_query_screens_cookie_t", bycopy.} = object
    sequence*: cuint

  XcbXineramaQueryScreensRequest* {.rename: "xcb_xinerama_query_screens_request_t", bycopy.} = object
    majorOpcode* {.importc: "major_opcode".}: uint8
    minorOpcode* {.importc: "minor_opcode".}: uint8
    length*: uint16

  XcbXineramaQueryScreensReply* {.rename: "xcb_xinerama_query_screens_reply_t", bycopy.} = object
    responseType* {.importc: "response_type".}: uint8
    pad0: uint8
    sequence*: uint16
    length*: uint32
...
when xcbDynlib:
  {.push dynlib: "libxcb-xinerama.so(|.0)".}
{.push cdecl.}
